      ...
      <div className="container-width">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            {/* Achievements */}
            <div>
              <h3 className="text-2xl font-semibold mb-6">Credentials & Experience</h3>
            ...
            <div className="relative">
              ...
              <div className="rounded-3xl overflow-hidden shadow-glass hover-lift">
                ...
                <div className="absolute top-6 left-6 glass-card p-4">
                  <div className="text-sm font-medium text-primary">Currently Accepting</div>
              ...
              <div className="absolute -top-4 -left-4 glass-card p-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                True transformation happens when we align our actions with our authentic values and vision.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <h4 className="text-xl font-semibold">Collaborative Partnership</h4>
              <p className="text-muted-foreground text-sm leading-relaxed">
                The best outcomes emerge from a partnership where client expertise meets professional guidance.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Lasting transformation requires building systems and habits that support long-term success.
              </p>
            </div>
          </div>
        </div>
